...
namespace langfvn.Areas.admin.Controllers
{
    public class CategoryFoodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CFoodID,CFoodName,CreatedDate")] CategoryFood categoryFood)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CFoodID,CFoodName,CreatedDate")] CategoryFood categoryFood)
        {
            if (ModelState.IsValid)
            {
                categoryFood.CreatedDate = DateTime.Now;
